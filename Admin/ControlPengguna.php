    ...
    <section class="formulir">
      <div class="gambar">
          ...
          <h1 class="text-center">ADMIN</h1>
            <li class="active"><a href="ControlPengguna.php">Control Pengguna</a></li>
           ...
           <?php
            ...
            <?php while($row=mysqli_fetch_assoc($hasil)): ?> 
                <tr>
                    ...
                    <td><?= $row['status'];?></td>
                    <td><a class="btn btn-primary btn-lg" href="../include/delete_proses.php?username=<?php echo $row['username']; ?>" role="button">Rekap</a></td>
                    </form>
                </tr>
